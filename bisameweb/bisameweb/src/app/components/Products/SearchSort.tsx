  ...
  return (
    <div className="flex items-center gap-4 p-4">
      <div className="flex-grow">
        ...
        <FilterButton
          label="Filter"
          styles="block md:hidden border border-orange-500 text-orange-500 text-sm px-6 py-1 hover:opacity-90 hover:scale transition-all duration-200 ease-in-out rounded-lg flex items-center gap-2"
