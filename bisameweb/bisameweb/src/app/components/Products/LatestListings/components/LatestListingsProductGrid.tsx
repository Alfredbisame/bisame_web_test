...
import LatestListingsProductCard from "./LatestListingsProductCard";
import { useRef, useState } from "react";

interface LatestListingsProductGridProps {
  products: Product[];
  onProductClick: (product: Product) => void;
}

const LatestListingsProductGrid = ({
  products,
  onProductClick,
}: LatestListingsProductGridProps) => {
...
export default LatestListingsProductGrid;
