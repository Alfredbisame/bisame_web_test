...
const RelatedProducts = () => {
  ...
  const { product: selectedProduct, isLoading: productLoading, hasError: productError } = useProductData(listingId || null);
  ...
  const { products, isLoading, isRetrying, error, retry, retryCount, totalCount, totalPages } = useRelatedProducts(
    category, 
    subCategory, 
    childCategory,
    currentPage,
  ...
  return (
    <div className="max-w-8xl mx-auto md:my-10 px-4 xl:px-52">
      <h2 className="text-2xl font-bold text-gray-800 mb-6 pb-2 border-b border-gray-200">Similar Ads</h2>
