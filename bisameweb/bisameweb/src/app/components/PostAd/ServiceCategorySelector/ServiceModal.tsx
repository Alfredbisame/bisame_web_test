...
import { useServiceData, searchChildCategories } from "./useServiceData";
...
export const ServiceModal: React.FC<ServiceModalProps> = ({
  ...
  const rawSearchResults = searchChildCategories(services, searchTerm);
  const searchResults = rawSearchResults.map((result) => ({
    childcategory: { childcategory: result.childcategory },
    parentSubcategory: result.parentSubcategory,
