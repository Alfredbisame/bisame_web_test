  ...
  const [products] = useState<Product[]>([
    {
      ...
      image: 'https://storage.googleapis.com/a1aa/image/971685fe-0cfd-4742-38be-5997a58c54ab.jpg',
      imageAlt: 'Hand holding an HP Elitebook 840 G3 laptop with screen showing a video call',
    ...
    },
    {
      ...
      image: 'https://storage.googleapis.com/a1aa/image/017c3a90-676e-4e43-dbdf-2135d907cda1.jpg',
      imageAlt: 'Front view of a Samsung Galaxy smartphone with a colorful screen',
      isAdminEnabled: true
    },
    {
      id: '3',
      ...
      image: 'https://storage.googleapis.com/a1aa/image/7daef0d0-ed90-4f41-0159-96a8e7e936fd.jpg',
      imageAlt: 'Side view of a Sony WH-1000XM4 wireless noise cancelling headphones in black',
      isAdminEnabled: false
    },
    {
      id: '4',
      ...
      image: 'https://storage.googleapis.com/a1aa/image/2acba102-8c0e-4af2-10e9-ab4297b993ee.jpg',
    ...
    },
    {
      ...
      image: 'https://storage.googleapis.com/a1aa/image/6d778a62-e02f-4cf9-7aa0-6f7762d81c84.jpg',
    ...
    },
    {
      ...
      image: 'https://storage.googleapis.com/a1aa/image/4c9a5d85-2140-4b04-ee32-7b52b2b1c674.jpg',
...
//   };
  ...
  return (
    <div className="bg-gray-50 min-h-screen flex flex-col mt-6">
      {/* Header */}
      <header className="bg-blue-900 flex items-center px-4 py-3 rounded-sm">
