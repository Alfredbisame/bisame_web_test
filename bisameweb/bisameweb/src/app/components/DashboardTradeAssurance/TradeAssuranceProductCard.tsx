...
const TradeAssuranceProductCard = ({ 
  ...
  return (
    <div className="group relative bg-gradient-to-br from-white via-gray-50 to-white rounded-xl shadow-xl hover:shadow-2xl transition-all duration-500 ease-out transform hover:-translate-y-2 border border-gray-100/50 backdrop-blur-sm overflow-hidden">
      ...
      <div className="relative z-10 flex p-6 space-x-4">
        <div className="relative">
          <Image
            ...
            className="rounded-xl object-cover w-32 h-32 flex-shrink-0 shadow-lg ring-2 ring-gray-100 group-hover:ring-blue-200 transition-all duration-300" 
            height={130} 
            src={product.image} 
            width={128}
          />
      ...
      {/* Animated border */}
      <div className="absolute inset-0 rounded-2xl bg-gradient-to-r from-blue-500 via-purple-500 to-cyan-500 opacity-0 group-hover:opacity-20 transition-opacity duration-500 -z-10 blur-xl"></div>
