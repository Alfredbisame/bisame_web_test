...
import JobSeekerFields from "./JobSeekersFields";
...
const JobSeekers: React.FC = () => {
  ...
  const { formData, initialFormData, setFormData } = useInitializeForm(data);
    ...
    <div className="bg-[#edf4f9] min-h-screen flex justify-center items-start p-6">
      ...
      >
        <CategoryHeader
          ...
          onBack={handleBack}
          title={`Post Your CV`}
          description={`Share your Job CV with the community`}
        />
