    ...
    <>
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 mt-6">
        {closedProducts.map((product) => {
          const imgSrc =
            imgSrcMap[product.id] || getImageUrl(product.image as string);
          return (
            <div
              key={product.id}
              className="border p-2 relative transition-all duration-300 hover:bg-gray-100 hover:shadow-md hover:scale-105 cursor-pointer rounded-md opacity-60"
            >
              {/* Status badge */}
              ...
              <div className="mt-4">
                ...
                <div className="mt-4">
                  ...
                  >
                    ...
                    {statusLoading ? "Reactivating..." : "Reactivate Listing"}
                  </button>
                </div>
                {/* Status indicator */}
