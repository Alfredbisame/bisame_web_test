    ...
    <>
     <div className="bg-white rounded-lg shadow-sm border border-gray-200">
      ...
      <div className="px-6 py-6 space-y-6">
        <div>
          <label className="block text-xs mb-1 text-gray-900" htmlFor="current-password">
            Current Password
          </label>
        ...
        <div>
          <label className="block text-xs mb-1 text-gray-900" htmlFor="new-password">
            New Password
          </label>
          <div className="relative">
            <input
        ...
        <div>
          <label className="block text-xs mb-1 text-gray-900" htmlFor="confirm-password">
            Confirm Password
          </label>
          <div className="relative">
            <input
