...
const EmptySavedProducts: React.FC = () => (
  <div className="text-center py-16">
    ...
    <h3 className="text-xl font-semibold text-gray-900 mb-2">No Saved Products</h3>
    <p className="text-gray-600 mb-6">You haven&apos;t saved any products yet. Start browsing to save your favorites!</p>
