...
const BrowsingHistory = () => {
  ...
  return (
    <div>
      <div className="max-w-7xl mx-auto">
        <div className="md:border border-gray-200 rounded-xl shadow-sm mt-4 mb-12 p-4">
          <div className="flex justify-between items-center mb-4">
            <h2 className="md:text-lg font-semibold">BROWSING HISTORY</h2>
            <Link
              href="/HistoryPage"
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                {recentViews.map((product) => (
                  <Link
                    ...
                    key={product._id}
                    className="border p-2 relative transition-all duration-300 hover:bg-gray-100 hover:shadow-md hover:scale-105 cursor-pointer rounded-md block"
                  >
