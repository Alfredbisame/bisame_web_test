...
const LoadingSkeleton = memo(() => (
  <div className="flex flex-col p-2 border-gray-200 shadow-sm h-80 space-y-3">
    <div className="h-10 w-40 rounded-lg bg-gray-200 animate-pulse self-end"></div>
    <div className="h-10 w-40 rounded-lg bg-gray-200 animate-pulse self-start"></div>
    <div className="h-10 w-40 rounded-lg bg-gray-200 animate-pulse self-end"></div>
    <div className="h-10 w-40 rounded-lg bg-gray-200 animate-pulse self-start"></div>
    <div className="h-10 w-40 rounded-lg bg-gray-200 animate-pulse self-end"></div>
    <div className="h-10 w-40 rounded-lg bg-gray-200 animate-pulse self-start"></div>
    ...
    return (
      <div className="flex-1 overflow-y-auto px-6 py-4 space-y-4">
        ...
        <div className="flex justify-center">
          <time className="text-center text-gray-500 text-sm bg-white px-4 py-2 rounded-full shadow-sm">
            {dateString}
          </time>
        </div>
