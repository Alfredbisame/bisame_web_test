...
const Messages: React.FC<MessagesProps> = ({ initialContext }) => {
  ...
  // Mobile-only view state (UI responsiveness only)
  ...
  return (
    <div className="w-full max-w-7xl mx-auto bg-orange-50 rounded-lg border border-gray-50 overflow-hidden">
      <ChatSystemHeader />

      <main className="flex flex-col lg:flex-row overflow-hidden h-[calc(100dvh-72px)] lg:h-[70vh]">
        <div
          className={[
            "h-full",
