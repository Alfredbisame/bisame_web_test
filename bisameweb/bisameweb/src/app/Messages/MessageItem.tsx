...
const MessageItem: React.FC<MessageItemProps> = ({
  ...
  return (
    <li
      className={`flex items-start p-4 space-x-3 cursor-pointer transition-colors hover:bg-gray-50 ${
    ...
    >
      {/* Avatar */}
      <div
        className={`flex items-center justify-center w-12 h-12 rounded-full ${message.avatarColor} text-white font-semibold flex-shrink-0`}
      >
        {message.avatarImage ? (
          <Image
